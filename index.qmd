...
total_population_delta <- county %>%
  ...
  mutate(
    `Population change, 2012-2017` = `2017` - `2012`,
    `Population change, 2017-2022` = `2022` - `2017`
  ) %>%
  select(County, `Population change, 2012-2017`, `Population change, 2017-2022`) %>%
  pivot_longer(
    cols = starts_with("Population change"),
    names_to = "Period",
