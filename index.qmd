...
ggplotly(total_units_plot, tooltip = "text") %>%
  layout(
    ...
    title = list(
      text = "Total housing units by county, 2012-2024",
...
ggplotly(total_population_plot, tooltip = "text") %>%
  layout(
    font = list(family = "Whitney Semibold", size = 12),
    title = list(
      text = "Northeastern Illinois population counts, 2012-2024",
      font = list(family = "Whitney Semibold", 
                  weight = "bold",
                  size = 32)
    ),
...
ggplotly(total_population_bar, tooltip = "text") %>%
  layout(
    font = list(family = "Whitney Semibold", size = 12),
    title = list(
      text = "Population counts<br>in northeastern Illinois, 2014-2024",
      font = list(family = "Whitney Semibold", 
                  weight = "bold",
                  size = 32)
    ),
...
ggplotly(type_plot, tooltip = "text") %>%
  layout(
    font = list(family = "Whitney Semibold", size = 12),
    title = list(
      text = "Housing types in<br>northeastern Illinois, 2015-2024",
      font = list(family = "Whitney Semibold", 
                  weight = "bold",
                  size = 32)
    ),
...
ggplotly(type_plot_Cook, tooltip = "text") %>%
  layout(
    font = list(family = "Whitney Semibold", size = 12),
    title = list(
      text = "Housing types in<br>Cook County, 2015-2024",
      font = list(family = "Whitney Semibold", 
                  weight = "bold",
                  size = 32)
    ),
...
ggplotly(type_plot_DuPage, tooltip = "text") %>%
  layout(
    font = list(family = "Whitney Semibold", size = 12),
    title = list(
      text = "Housing types in<br>DuPage County, 2015-2024",
      font = list(family = "Whitney Semibold", 
                  weight = "bold",
                  size = 32)
    ),
...
ggplotly(type_plot_Kane, tooltip = "text") %>%
  layout(
    font = list(family = "Whitney Semibold", size = 12),
    title = list(
      text = "Housing types in<br>Kane County, 2015-2024",
      font = list(family = "Whitney Semibold", 
                  weight = "bold",
                  size = 32)
    ),
...
ggplotly(type_plot_Kendall, tooltip = "text") %>%
  layout(
    font = list(family = "Whitney Semibold", size = 12),
    title = list(
      text = "Housing types in<br>Kendall County, 2015-2024",
      font = list(family = "Whitney Semibold", 
                  weight = "bold",
                  size = 32)
    ),
...
ggplotly(type_plot_Lake, tooltip = "text") %>%
  layout(
    font = list(family = "Whitney Semibold", size = 12),
    title = list(
      text = "Housing types in<br>Lake County, 2015-2024",
      font = list(family = "Whitney Semibold", 
                  weight = "bold",
                  size = 32)
    ),
...
ggplotly(type_plot_McHenry, tooltip = "text") %>%
  layout(
    font = list(family = "Whitney Semibold", size = 12),
    title = list(
      text = "Housing types in<br>McHenry County, 2015-2024",
      font = list(family = "Whitney Semibold", 
                  weight = "bold",
                  size = 32)
    ),
...
ggplotly(type_plot_Will, tooltip = "text") %>%
  layout(
    font = list(family = "Whitney Semibold", size = 12),
    title = list(
      text = "Housing types in<br>Will County, 2015-2024",
      font = list(family = "Whitney Semibold", 
                  weight = "bold",
                  size = 32)
    ),
