...
htmlwidgets::saveWidget(as_widget(total_population_bar_plotly), ".\\docs\\population_bar.html", selfcontained = T)
```
### delta population
...
ggplotly(delta_population_plot, tooltip = "text") %>%
  layout(
    font = list(family = "Whitney Semibold", size = 12),
    title = list(
...
htmlwidgets::saveWidget(as_widget(total_population_bar_delta), ".\\docs\\population_bar.html", selfcontained = T)
```
