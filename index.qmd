...
total_units_plot <- county %>%
  ...
  ggplot(aes(x = year, 
             ...
             color = GEOG,
             group = GEOG,
             text = paste("County:", GEOG,
                          "<br>Year", year,
                          "<br>Total housing units", comma(HU_TOT)))) +
...
total_units_plotly <- 
  ggplotly(total_units_plot) %>%
   layout(
    ...
    title = list(font = list(family = "Whitney", size = 16)),
    xaxis = list(title = list(font = list(family = "Whitney", size = 14))),
    yaxis = list(title = list(font = list(family = "Whitney", size = 14))),
    legend = list(font = list(family = "Whitney", size = 12))
  )
